...
<div class="dataTables_paginate">
    ...
    "index.php?controller=<?php echo $_GET['controller']; ?>&action=show&page=1<?php echo $_GET['link'],$_GET['order']; ?>">First</a>

    <?php 
        if ($_GET['page']>1){ 
    ?>
    <a class="previous paginate_button" href=
    "index.php?controller=<?php echo $_GET['controller']; ?>&action=show&page=<?php echo $_GET['page']-1; ?><?php echo $_GET['link'],$_GET['order']; ?>">
    Previous</a>
    <?php 
        } else{ 
    ?>
    ...
    <span>
        ...
        "index.php?controller=<?php echo $_GET['controller']; ?>&action=show&page=<?php echo $_GET['page']; ?><?php echo $_GET['link'],$_GET['order']; ?>">
    ...
    Next</a>
    <?php }; ?>
    <a class="last paginate_button" href="index.php?controller=<?php echo $_GET['controller']; ?>&action=show&page=<?php echo $max_pages; ?><?php echo $_GET['link'],$_GET['order']; ?>">
    Last</a>
</div>